...
import { mockSnippets, mockLanguages, mockTags, mockFolders } from './IndexData';
...
const Dashboard = () => {
  ...
  const [filteredSnippets, setFilteredSnippets] = useState<Snippet[]>(mockSnippets);
  ...
  useEffect(() => {
    ...
    if (activeTab === 'recent') {
      ...
      filtered = filtered.filter(s => s.usageCount > 15);
    }
              ...
              <div className="bg-snippet-bg border border-snippet-border rounded-lg p-6 animate-fade-in">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-xl font-bold font-jetbrains">Demo User</h2>
